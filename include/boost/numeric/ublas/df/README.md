...
* `column.hpp` defines a column of a frame, similar to Series in Pandas.
...
More discussion is needed on whether the following features are to be implemented.

* Expression template implementation of data frame which enables lazy evaluation with broadcasting. 
